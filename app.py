...
# ==========================================
    ...
    st.write(f"👤 **ผู้บันทึก:** {st.session_state.emp_name} ({st.session_state.emp_id}) | 🛠️ **ตำแหน่ง:** {st.session_state.emp_position}")
    st.markdown("---")
            ...
            if len(valid_imgs) >= 3:
                if st.button("ยอมรับ และบันทึกข้อมูลผลการตรวจสอบ 🚀", type="primary", use_container_width=True):
                    with st.spinner("⏳ กำลังบันทึกเวลาปัจจุบันและยิงรูปเข้าคลังไฟล์ระบบ..."):
                        ...
                        # 4. 🚀 เชื่อมต่อไปยังลิงก์ Google Apps Script ของพี่โดยตรง
                        webhook_url = "https://script.google.com/macros/s/AKfycbwP17tkIo9dN1vugBL6eO41E0nYysrwXZfUhobKEu6v58f0oOhciFnBdvB0XW1EblfKUA/exec"
